...
const riddles = [
  // === EASY (1) ===
  { riddle: "I’m full of holes but keep things inside. What am I?", answers: ["sponge"], difficulty: 1 },
  { riddle: "I have a neck but no head. What am I?", answers: ["bottle"], difficulty: 1 },
  { riddle: "You can hold me, but I’m not a thing. What am I?", answers: ["breath"], difficulty: 1 },
  { riddle: "I go up but never come down. What am I?", answers: ["age"], difficulty: 1 },
  { riddle: "I’m white and cold and fall from the sky. What am I?", answers: ["snow"], difficulty: 1 },
  { riddle: "I follow you but cast no sound. What am I?", answers: ["shadow"], difficulty: 1 },
  { riddle: "I hang around in closets and never talk. What am I?", answers: ["hanger"], difficulty: 1 },
  { riddle: "I buzz around and sometimes sting. What am I?", answers: ["bee"], difficulty: 1 },
  { riddle: "I spin without legs and fly without wings. What am I?", answers: ["top", "spinning top"], difficulty: 1 },
  { riddle: "I drip but never cry. What am I?", answers: ["faucet", "tap"], difficulty: 1 },

  // === MEDIUM (2) ===
  { riddle: "I flicker and dance, but I’m not alive. What am I?", answers: ["flame", "fire"], difficulty: 2 },
  { riddle: "I get sharper the more you use me, until I snap. What am I?", answers: ["pencil"], difficulty: 2 },
  { riddle: "I move without legs and murmur without a mouth. What am I?", answers: ["river", "stream"], difficulty: 2 },
  { riddle: "I have keys but no locks. What am I?", answers: ["keyboard", "piano"], difficulty: 2 },
  { riddle: "I count but never talk. What am I?", answers: ["calculator"], difficulty: 2 },
  { riddle: "I shine but am not a star. What am I?", answers: ["lightbulb"], difficulty: 2 },
  { riddle: "I hold time and hide in your pocket. What am I?", answers: ["watch", "pocket watch"], difficulty: 2 },
  { riddle: "I eat up everything and never get full. What am I?", answers: ["fire"], difficulty: 2 },
  { riddle: "I speak in code but have no mouth. What am I?", answers: ["computer"], difficulty: 2 },
  { riddle: "I vanish when you turn. What am I?", answers: ["shadow"], difficulty: 2 },

  // === HARD (3) ===
  { riddle: "I hide in riddles and flee from fact. What am I?", answers: ["paradox"], difficulty: 3 },
  { riddle: "The more you erase me, the louder I get. What am I?", answers: ["memory"], difficulty: 3 },
  { riddle: "I echo your every move but can’t move first. What am I?", answers: ["reflection"], difficulty: 3 },
  { riddle: "I bloom in silence, wither in noise. What am I?", answers: ["thought"], difficulty: 3 },
  { riddle: "I rise from decay, yet end with beauty. What am I?", answers: ["mushroom"], difficulty: 3 },
  { riddle: "I am heard but never spoken, seen but never touched. What am I?", answers: ["song", "music"], difficulty: 3 },
  { riddle: "I twist truths into shapes you want. What am I?", answers: ["lie", "illusion"], difficulty: 3 },
  { riddle: "I never stop moving but go nowhere. What am I?", answers: ["time"], difficulty: 3 },
  { riddle: "I am the end of questions and the start of regret. What am I?", answers: ["answer"], difficulty: 3 },
  { riddle: "You only see me when everything else disappears. What am I?", answers: ["darkness"], difficulty: 3 }
];
