...
const riddles = [
  // === EASY (1) ===
  { riddle: "I have hands but cannot clap. What am I?", answers: ["clock"], difficulty: 1 },
  { riddle: "I have teeth but never bite. What am I?", answers: ["comb"], difficulty: 1 },
  { riddle: "I have a neck but no head. What am I?", answers: ["bottle"], difficulty: 1 },
  { riddle: "I have many keys but open no locks. What am I?", answers: ["keyboard", "piano"], difficulty: 1 },
  { riddle: "I go up and down but never move. What am I?", answers: ["stairs", "staircase", "stairway"], difficulty: 1 },
  { riddle: "I have a bed but never sleep. What am I?", answers: ["river"], difficulty: 1 },
  { riddle: "I can ring without fingers. What am I?", answers: ["telephone", "phone", "bell"], difficulty: 1 },
  { riddle: "You can catch me but not throw me. What am I?", answers: ["cold"], difficulty: 1 },
  { riddle: "I run around a yard but never move. What am I?", answers: ["fence"], difficulty: 1 },
  { riddle: "I get wetter the more I dry. What am I?", answers: ["towel"], difficulty: 1 },
  { riddle: "I have cities but no houses, roads but no cars. What am I?", answers: ["map"], difficulty: 1 },
  { riddle: "The more of me there is, the less you see. What am I?", answers: ["fog", "mist"], difficulty: 1 },
  { riddle: "I open and close without a key. What am I?", answers: ["zipper", "zip"], difficulty: 1 },
  { riddle: "I have a spine and stories but no lungs. What am I?", answers: ["book"], difficulty: 1 },
  { riddle: "I have ears but cannot hear. What am I?", answers: ["corn"], difficulty: 1 },
  { riddle: "Bought by the yard, worn by the foot. What am I?", answers: ["carpet", "rug"], difficulty: 1 },
  { riddle: "I live in a nest but do not chirp. What am I?", answers: ["egg"], difficulty: 1 },
  { riddle: "I sit in a corner yet travel the world. What am I?", answers: ["stamp"], difficulty: 1 },
  { riddle: "I’m cracked, made, told, and played. What am I?", answers: ["joke"], difficulty: 1 },
  { riddle: "I go up when the rain comes down. What am I?", answers: ["umbrella"], difficulty: 1 },

  // === MEDIUM (2) ===
  { riddle: "I shave every day, but my beard stays. Who am I?", answers: ["barber"], difficulty: 2 },
  { riddle: "I build up castles, level mountains, and blind some. What am I?", answers: ["sand"], difficulty: 2 },
  { riddle: "I have a heart that doesn’t beat. What am I?", answers: ["artichoke"], difficulty: 2 },
  { riddle: "I’m carried by feet but never walk. What am I?", answers: ["shoe", "shoes"], difficulty: 2 },
  { riddle: "I start with E, end with E, and usually hold just one letter. What am I?", answers: ["envelope"], difficulty: 2 },
  { riddle: "I have branches but no fruit, trunk, or leaves. What am I?", answers: ["bank"], difficulty: 2 },
  { riddle: "I can be long or short; I can be grown or bought; I can be painted or left bare. What am I?", answers: ["nails", "fingernails"], difficulty: 2 },
  { riddle: "I go through towns and hills but never move. What am I?", answers: ["road", "highway", "roadway"], difficulty: 2 },
  { riddle: "I have an eye but cannot see. What am I?", answers: ["needle", "hurricane", "potato"], difficulty: 2 },
  { riddle: "I’m a room you cannot enter. What am I?", answers: ["mushroom"], difficulty: 2 },
  { riddle: "Turn me once to let in, twice to lock out. What am I?", answers: ["key"], difficulty: 2 },
  { riddle: "I’m always answered but never ask. What am I?", answers: ["doorbell", "bell"], difficulty: 2 },
  { riddle: "I have a head and a tail but no body. What am I?", answers: ["coin"], difficulty: 2 },
  { riddle: "Found once in a minute, twice in a moment, and never in a thousand years. What am I?", answers: ["m"], difficulty: 2 },
  { riddle: "I break easily without being touched. What am I?", answers: ["promise"], difficulty: 2 },
  { riddle: "I go in dry and come out wet; the longer I steep, the stronger I get. What am I?", answers: ["tea", "teabag", "tea bag"], difficulty: 2 },
  { riddle: "I make two people out of one. What am I?", answers: ["mirror"], difficulty: 2 },
  { riddle: "Feed me paper and I’ll grow—yet I’m not alive. What am I?", answers: ["shredder"], difficulty: 2 },
  { riddle: "Lines and a spine keep me in order. What am I?", answers: ["notebook", "binder"], difficulty: 2 },
  { riddle: "I’m passed around in games but never thrown. What am I?", answers: ["turn"], difficulty: 2 },

  // === HARD (3) ===
  { riddle: "The more you feed me, the more I grow; give me a drink and I die. What am I?", answers: ["fire"], difficulty: 3 },
  { riddle: "I pull you without ropes and keep moons in line. What am I?", answers: ["gravity"], difficulty: 3 },
  { riddle: "I’m called the mother of invention. What am I?", answers: ["necessity"], difficulty: 3 },
  { riddle: "I eat stone for a living and never chew. What am I?", answers: ["erosion"], difficulty: 3 },
  { riddle: "I grow when shared and shrink when hoarded. What am I?", answers: ["knowledge"], difficulty: 3 },
  { riddle: "I retreat as you approach and circle the world. What am I?", answers: ["horizon"], difficulty: 3 },
  { riddle: "I fly from mouth to mouth and swell with telling. What am I?", answers: ["rumor", "gossip"], difficulty: 3 },
  { riddle: "I answer without a word and copy your mistakes. What am I?", answers: ["reflection"], difficulty: 3 },
  { riddle: "I guard treasures, fear a single guess, and live in secrecy. What am I?", answers: ["password"], difficulty: 3 },
  { riddle: "I’m a chain you forge yourself—easy to make, hard to break. What am I?", answers: ["habit"], difficulty: 3 },
  { riddle: "I split the whole into colors without a blade. What am I?", answers: ["prism"], difficulty: 3 },
  { riddle: "I write history without ink and carve valleys without tools. What am I?", answers: ["time"], difficulty: 3 },
  { riddle: "I hold you captive without bars and steer you without reins. What am I?", answers: ["bias"], difficulty: 3 },
  { riddle: "I start fights and end silences, yet I’m only air shaped by tongues. What am I?", answers: ["words", "speech"], difficulty: 3 },
  { riddle: "I can’t be bought, but I can be spent; lose me and you’ll never find me. What am I?", answers: ["time"], difficulty: 3 },
  { riddle: "I am the echo of choices, cast ahead of you. What am I?", answers: ["consequence"], difficulty: 3 },
  { riddle: "I’m born when lines meet and vanish when you cross me. What am I?", answers: ["boundary", "border", "line"], difficulty: 3 },
  { riddle: "I am the map inside a maze: follow me and you still might be lost. What am I?", answers: ["intuition", "instinct"], difficulty: 3 },
  { riddle: "I move faster when I’m short and crawl when I’m long. What am I?", answers: ["queue", "line", "wait"], difficulty: 3 },
  { riddle: "I’m the weight of what-ifs you never lifted. What am I?", answers: ["regret"], difficulty: 3 },
];
