...
const MOVIE_THEATER_STORIES = {
  hidingSpots: [
    "Under a recliner, {victim} lasted until the footrest folded shut and security dragged them out by the ankles.",
    "Behind the screen, {victim} tried to disappear and got booted for tampering with cinematic destiny.",
    "Inside the janitor closet, {victim} was caught trying to dodge the ushers while smelling like mop water and guilt.",
    "The projector booth briefly welcomed {victim}, then kicked them out for 'unauthorized directing.'",
    "Beneath a mountain of coats in the back row, {victim} stayed hidden until an usher found the pile blinking.",
    "Behind the arcade machine in the lobby, {victim} was removed for loitering with intent.",
    "A nacho cheese drip betrayed {victim} while they were flattened under the snack counter.",
    "Tucked into the wheelchair space, {victim} was escorted out for fake accessibility theater.",
    "Inside the cardboard movie standee, {victim} stayed quiet right up until it started whispering.",
    "By the emergency exit curtain, {victim} was thrown out for looking extremely flammable.",
    "At the butter refill station, staff discovered {victim} trying to live inside a popcorn bucket.",
    "The lost-and-found bin returned {victim} to the lobby marked 'unclaimed nonsense.'",
    "Behind row J, {victim} got caught chewing a seat bracket like contraband gum.",
    "Up in the ceiling tiles above the lobby, {victim} vanished for a while and then dropped directly into a security incident.",
    "Folded into a cup holder, {victim} was removed for being aggressively unsanitary.",
    "The closed caption device cabinet got {victim} kicked out for unauthorized subtitles.",
    "Under the giant claw machine in the lobby, {victim} was hauled out like a rigged prize.",
    "Trying to blend in with the trash near the exit, {victim} was taken out with the cleanup round.",
  ],
  clumsiness: [
    "A full soda went down three rows, and {victim} got kicked out before the ice even stopped bouncing.",
    "Over the glowing aisle lights, {victim} tripped and face-planted into a family combo meal.",
    "Between reclining seats, {victim} attempted a leap and got ejected for reckless row conduct.",
    "Security called it a hostile event after {victim} fumbled a popcorn refill that badly.",
    "During the quietest scene, {victim} stood up, lost balance, and pinballed through six offended viewers.",
    "On a sprint to the restroom during a jump scare, {victim} took out the wet floor sign along the way.",
    "Under row F, {victim} crawled after a dropped phone and emerged banned on sight.",
    "The handrail met {victim}'s skull after they misjudged the step into the theater with enough noise to end their night.",
    "Staff assumed sabotage when {victim} spent that long opening a crinkly candy bag, and removed them anyway.",
    "Trying to sneak in an entire pizza, {victim} slipped on the grease and got escorted out in disgrace.",
    "A full-theater incident response began when {victim} confused the emergency exit for the bathroom.",
    "Caught in a folding seat, {victim}'s hoodie started a disturbance they could not survive socially.",
    "One dramatic aisle strut from {victim} clipped a drink tray hard enough to become a cautionary tale.",
    "The entire row voted {victim} off the premises after they laughed at the exact wrong scene with full commitment.",
    "While using a flashlight to find dropped candy, {victim} got removed for running an unauthorized search operation.",
    "Collective willpower launched {victim} into the lobby after one seat-kick too many.",
    "Mid-movie, {victim} tried to switch seats, tripped over three footrests, and got tossed for chaotic migration.",
    "At a silent scene, {victim}'s squeaky shoes taught them exactly where the theater staff draw the line.",
  ],
  sabotage: [
    "Before the appeal could begin, security launched {victim} into the lobby after {killer} told staff they were recording the movie.",
    "By planting a burrito under the seat, {killer} framed {victim} for bringing outside snacks.",
    "The row turned on {victim} instantly after {killer} whispered that spoilers had been coming from their seat.",
    "Every word was believed when {killer} blamed {victim} for the phone glow in row D.",
    "After swapping the spilled soda with {victim}'s cup, {killer} watched the ushers escort the wrong Squig out.",
    "While actively doing the seat-kicking, {killer} reported {victim} for it with astonishing confidence.",
    "Contraband candy wrappers appeared in {victim}'s lap, and {killer} yelled for an usher like a narc with purpose.",
    "Security skipped the investigation entirely after {killer} claimed {victim} pulled the fire door handle.",
    "When the projector glitched, {killer} pointed at {victim}, and somehow that was enough.",
    "The flashlight squad accepted the assignment the second {killer} told the manager {victim} snuck in without a ticket.",
    "For leaking the ending, {killer} framed {victim} and let the theater punish the offense immediately.",
    "Culinary dishonesty became {victim}'s downfall once {killer} blamed the smell of outside pizza on them.",
    "As soon as {killer} declared {victim} the mastermind behind the talking in row H, the ushers pounced.",
    "Under {victim}'s seat, {killer} tucked a recording light-up toy and sold the story with confidence.",
    "The bounce was swift after {killer} convinced staff that {victim} had swapped into premium seats without authorization.",
    "Claiming {victim} started the popcorn fight, {killer} vanished behind innocence while security handled the rest.",
    "The moment the alarm chirped, {killer} pointed to {victim} and let theater law do what theater law does.",
    "For sneaking into a second screening, {killer} framed {victim} and got them ejected for serial cinema fraud.",
  ],
  resurrections: [
